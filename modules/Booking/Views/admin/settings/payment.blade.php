                                            ...
                                            <div class="col-md-11">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p><i>{{__('Example: Main currency is EUR, and the extra currency is USD, so the exchange rate must be 23400 (1 EUR ~ 1.67 USD)')}}</i></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                        ...
                                        <div class="col-md-11">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <p><i>{{__('Example: Main currency is EUR, and the extra currency is USD, so the exchange rate must be 1.67 (1 EUR ~ 1.67 USD)')}}</i></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-1">
