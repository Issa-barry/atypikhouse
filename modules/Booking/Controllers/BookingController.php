...
//use Modules\Booking\Events\VendorLogPayment; // future function
    ...
    public function doCheckout(Request $request)
    {
        ...
        if($booking->wallet_total_used > 0){
            if($how_to_pay == 'full'){
                ...
                // Ex : pay deposit 10€ but guest input 20€ -> minus credit balance = 10€ // test function
...
//        event(new VendorLogPayment($booking)); // log for events
        ...
        if($booking->pay_now > 0) {
            ...
            return $this->sendSuccess( [
                'url'=>$booking->getDetailUrl()
            ], __("You payment has been processed successfully on the AtypikHouse"));
        }
    }
