 ...
 */
    ...
    class TourPolicy
    {
        ...
        /**
         * Determine whether the user can view any tours on the AtypikHouse
         *
         * @param \App\User $user
         * @return mixed
         */
        ...
        public function viewAny(User $user)
        {
            if (!$this->vendorEnable) {
                abort('404', 'Tour has disable on the AtypikHouse.');
            }
            //
        }
            ...
            if ($this->vendorEnable) {
                if ($this->maxCreate == false) {
                    ...
                    if ($this->totalTour < $this->maxCreate) {
                        ...
                        abort('403', "You can't create tour on the AtypikHouse");
