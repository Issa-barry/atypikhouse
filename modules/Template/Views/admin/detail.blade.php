                ...
                <div class="lang-content-box">
                    <div class="panel">
                        ...
                        <div class="panel-footer text-right">
                            ...
                            <span class="btn btn-success" @click="saveTemplate">{{__("Enregistrer Template")}}
...
@section ('script.head')
    <script>
        var template_i18n = {
            cancel: '{{__('Annuler')}}',
            save_changes: '{{__('Enregistrez les modifications.')}}',
            delete_confirm: '{{__('Voulez-vous supprimer?')}}',
            add_new: '{{__('Ajouter')}}',
        };
    </script>
@endsection
