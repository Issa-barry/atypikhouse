<form class="bravo-form-login" method="POST" action="{{ route('login') }}">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" autocomplete="off" placeholder="{{__('Address email')}}">
    ...
    <div class="form-group">
        <div class="d-flex justify-content-between">
            <label for="remember-me" class="mb0">
                <input type="checkbox" name="remember" id="remember-me" value="1"> {{__('Se souvenir de moi sur AtypikHouse')}} <span class="checkmark fcheckbox"></span>
            </label>
    ...
    @endif
    <div class="c-grey font-medium f14 text-center"> {{__('Pas d’identifiant AtypikHouse ?')}} <a href="" data-target="#register" data-toggle="modal">{{__(' Créez-en un !')}}</a>
    </div>
</form>
