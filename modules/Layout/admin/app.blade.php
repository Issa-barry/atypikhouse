...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'AtypikHouse'}}</title>
    ...
    <script>
        ...
        var i18n = {
            warning:"{{__("Warning")}}",
            success:"{{__("Success")}}",
            confirm_delete:"{{__("Voulez-vous supprimer ?")}}",
            confirm_recovery:"{{__("Voulez-vous restaurer ?")}}",
            confirm:"{{__("Confirm")}}",
            cancel:"{{__("Cancel")}}",
        };
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('AtypikHouse par')}} <a href="{{__('https://f2i-dev2-dc-ib-rv-ch.fr/')}}" target="_blank">{{__('CIDR Agency')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('#')}}" target="_blank">{{__('Apropos de nous')}}</a>
                            <a href="{{__('https://roterman.dev')}}" target="_blank">{{__('IBARRY')}}</a>
                        </div>
                    </div>
                </div>
            </div>
