    ...
    <form action="{{route('location.admin.category.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar">{{$row->id ? __('Edit: ').$row->name : __('Ajouter une nouvelle catégorie.')}}</h1>
                </div>
                <div class="">
                    @if($row->slug)
                    ...
                    <div class="col-md-9">
                        <div class="panel">
                            <div class="panel-body">
                                <h3 class="panel-body-title">{{__("Categorie Content")}}</h3>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-save"></i> {{__('Enregistrer')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
