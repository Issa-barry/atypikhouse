        ...
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">
                @if(!empty($row->id))
                    {{__("Edit Menu:")}} @{{name}}
                @else
                    {{__('Créer un nouveau menu sur AtypikHouse')}}
                @endif
            </h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-xl-3 menu-item-types">
                ...
                <div class="panel panel-toggle-able">
                    <div class="panel-title" @click="custom_show = custom_show ? false : true">{{__('URL')}}
                        <i class="icon ion-md-arrow-dropdown"></i>
                    </div>
            ...
            <div class="col-md-8 col-xl-9">
                ...
                <div class="lang-content-box">
                    <div class="panel">
                    <div class="panel-title">{{__('Éléments du menu')}}</div>
