<div class="row">
    ...
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-title"><strong>{{__('Options générales AtypikHouse')}}</strong></div>
...
@if(is_default_lang())
    ...
    <div class="row">
        <div class="col-sm-4">
            <h3 class="form-group-title">{{__("Custom CSS for all languages on the AtypikHouse")}}</h3>
            <p class="form-group-desc">{{__('css code')}}</p>
        </div>
        <div class="col-sm-8">
            <div class="panel">
