...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Social Login on the AtypikHouse")}}</h3>
        <p class="form-group-desc">{{__('')}}</p>
    </div>
    <div class="col-sm-8">
...
<div class="row">
    <div class="col-sm-4">
        ...
        <p class="form-group-desc">{{__('Example: Google Analytics etc')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Cookie agreement on the AtypikHouse")}}</h3>
    </div>
    <div class="col-sm-8">
        <div class="panel">
