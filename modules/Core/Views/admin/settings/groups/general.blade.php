<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Information")}}</h3>
        <p class="form-group-desc">{{__('')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label>{{__("Premier jour de la semaine pour les calendriers")}}</label>
                    <div class="form-controls">
...
<div class="row">
    <div class="col-sm-4">
        ...
        <p class="form-group-desc">{{__('Langue principale sur le site AtypikHouse')}}</p>
    </div>
    <div class="col-sm-8">
        <div class="panel">
            <div class="panel-body">
...
<div class="row">
    <div class="col-sm-4">
        <h3 class="form-group-title">{{__("Contact page AtypikHouse")}}</h3>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <textarea name="page_contact_desc" class="d-none has-ckeditor" cols="30" rows="7">{{setting_item_with_lang('page_contact_desc',request()->query('lang'),'<p>Tell. + 123456789</p>
<p>Email. contact@atypikhouse.com</p>
<p class="address">Paris, France</p>
<p>            <!--<p>Tell. + 123456789</p>
            <p>Email. contact@atypikhouse.com</p>
            <p class="address">Paris, France</p>-->
        </p>') }}</textarea>
                    </div>
