...
//    use Modules\Vendor\Models\VendorPlan; // its function for future
    ...
    class User extends Authenticatable implements MustVerifyEmail,JWTSubject,Wallet
    {
        ...
        protected $fillable = [
            ...
            'business_name',
            'status',
//            'vendor_plan_id',  - future function
//            'vendor_plan_enable',  - future function
//            'vendor_plan_start_date',  - future function
//            'vendor_plan_end_date',  - future function
        ];
